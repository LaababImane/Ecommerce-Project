<template>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <div class="row">
                            <div class=" shadow col-md-4 product-box" v-for="(order,index) in orders" :key="index">
                                <img :src="order.product.image" style="width:140px" :alt="order.product.name">
    ...
    .product-box { border: 1px solid #ffffff; padding: 10px 15px; }
    .hero-section { background: #212529; height: 20vh; align-items: center; margin-bottom: 20px; margin-top: 103px; }
