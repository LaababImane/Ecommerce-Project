   <template>
        <div class="container">
            <div class="row" style="padding-top: 100px;">
                <div class="col-md-8 offset-md-2">
                    <div class="shadow order-box">
                        <img  :src="product.image" width="130px" :alt="product.name">
                    ...
                    <div>
                        ...
                        <div v-if="isLoggedIn">
                            ...
                            <br>
                            <button class="col-md-4 btn btn-sm btn-success float-right" style="padding: 16px 20px; 
                                        border: none;
                                        cursor: pointer;
                                        width: 100%; " v-if="isLoggedIn" @click="placeOrder">Continue</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    .order-box { border: 1px solid #fff; padding: 10px 15px; }
