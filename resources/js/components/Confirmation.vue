<template>
        <div>
            <div class="container-fluid hero-section d-flex align-content-center justify-content-center flex-wrap ml-auto bg-white">
                <h2>
    ...
    .product-box { border: 1px solid #ffff; padding: 10px 15px; }
